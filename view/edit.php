...
<?php foreach ($pages as $page){if ($page['difficulty'] == "easy"){echo "checked='checked'";}}?>
		...
		<h2>Image Name:</h2>
		<input type="text" name="image_name" value="<?php foreach($pages as $page){ echo $page['image_name'];} ?>" required /><br />
